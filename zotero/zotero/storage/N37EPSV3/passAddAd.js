(function($){
    'use strict';
    $(function(){
        var url='https://api.site.hujiang.com/Web/tx.ashx';
        var adTpl;
        var isTrue=false;
        ...
        passAddAd.requireCss('https://common.hjfile.cn/site/css/passAddAd.css?v='+ new Date().getTime());
        if(!!window.getLangs){
            ...
            if(/^(en|jp|kr|fr|de|es|th|ru|xx|ye|zx|gk|kaoyan|all)$/.test(pagelangs)){
