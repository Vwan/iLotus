    ...
    $(function(){
        ...
        var bottomActive1212={
            ...
            render:function(langs){
                $.ajax({
                    url:'https://api.site.hujiang.com/Web/tx.ashx',
                    dataType:'jsonp',
                    data:{
                        op:'GetTxInfoList',
                        txID:'20',
                                ...
                                success:function(data2){
                                    if(data2&&data2.Value.Length>0){
                                        ...
                                        var bottomActive1212HTML =
                                            ...
                                            '                <img src="'+bannerPic+'" />'+
                                            '            </a>'+
                                            '            <img src="https://i2.w.hjfile.cn/doc/201511/4ee4d8eae1ca428da5359bd7dbfd0926.png" class="bottomActive1212CloseBtn" />'+
                                            '        </div>'+
                                            '    </div>'+
                                            '</div>'+
            ...
            initCss:function(){
                var cssUrl='https://common.hjfile.cn/site/css/bottomActive1212.css?version=' + this.getTimeToMin();
        ...
        if(!!window.getLangs){
            ...
            if(/^(en|jp|kr|fr|de|es|th|ru|xx|ye|zx|gk|kaoyan)$/.test(pagelangs)){
